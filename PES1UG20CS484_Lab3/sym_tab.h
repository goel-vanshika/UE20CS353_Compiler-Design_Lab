...
void insert_symbol(char* name, int size, int type, int lineno,int scope); 		// symbols into the table when declared
int insert_val(char* name, char* v, int line);	//inserts values into the table when initialised		
